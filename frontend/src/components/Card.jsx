...
export default function Card() {
    return (
        <div className="w-[10rem] h-[18rem] p-2 py-1 rounded-2xl drop-shadow-md flex flex-col items-center justify-around bg-dark-2">
            <div className="w-[8rem] h-[8rem] bg-primary rounded-2xl mb-2 overflow-hidden">
                <img src={a} className="mt-[-4rem]" alt="dummy" />
            </div>
