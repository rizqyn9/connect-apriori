...
const TH = ({ className, ...rest }: THProps) => <th {...rest} className={clsx('border-2 border-white py-3 px-3', className)} />

type TRProps = HTMLAttributes<HTMLTableRowElement>
const TR = ({ className, ...rest }: TRProps) => <tr {...rest} className={clsx('even:bg-primary/30 px-3 whitespace-nowrap', className)} />
